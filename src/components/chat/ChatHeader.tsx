      ...
      <div className="@container flex items-center justify-between py-1">
        <div className="flex items-center space-x-2">
          <Button
            ...
            variant="ghost"
            className="hidden @2xs:flex items-center justify-start gap-1.5 mx-1.5 sm:mx-2 py-2.5"
          >
            <PlusCircle size={16} />
            <span>New Chat</span>
          </Button>
          <Button
            ...
            variant="ghost"
            className="hidden @6xs:flex cursor-pointer items-center gap-1 text-xs sm:text-sm px-1.5 sm:px-2 py-1 rounded-md"
          >
            <History size={16} />
            {versionsLoading
              ? "..."
